...
namespace DreamScape.Models
{
    public class AppDbContext : DbContext
    {
        ...
        new Item { Id = 2, Name = "Schaduwkap", Description = "Een mysterieuze kap die de drager in duisternis hult.", Type = ItemType.Armor, Rarity = 40, Power = 20, Speed = 40, Durability = 90, Magic = 50 },
        new Item { Id = 3, Name = "Amulet van Genezing", Description = "Een amulet dat helende krachten bezit.", Type = ItemType.Accessory, Rarity = 15, Power = 10, Speed = 50, Durability = 70, Magic = 90 },
        ...
        new Item { Id = 5, Name = "IJzeren Harnas", Description = "Een stevig harnas dat bescherming biedt tegen fysieke aanvallen.", Type = ItemType.Armor, Rarity = 30, Power = 30, Speed = 20, Durability = 100, Magic = 0 },
        ...
        new Item { Id = 7, Name = "Toverstaf van Verwarring", Description = "Een toverstaf die vijanden in verwarring brengt.", Type = ItemType.Weapon, Rarity = 50, Power = 60, Speed = 60, Durability = 50, Magic = 80 },
        ...
        new Item { Id = 19, Name = "Vuurzwaard", Description = "Een zwaard dat brandende vuurprojectielen afvuurt.", Type = ItemType.Weapon, Rarity = 50, Power = 70, Speed = 50, Durability = 60, Magic = 30 },
